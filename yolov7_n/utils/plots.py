...
#AGGIUNTA 
def plot_images(images, targets, paths=None, fname='images.jpg', names=None, max_size=640, max_subplots=16, is_magnetogram=False):
    ...
    for i, img in enumerate(images):
        ...
        if is_magnetogram:
            ...
            # --- Logica Originale per immagini normali ---
