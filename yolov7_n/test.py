...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        if plots and batch_i < 3:
           ...
           Thread(target=plot_images, args=(img, output_to_target(out), paths, f, names), kwargs={'is_magnetogram': is_magnetogram}, daemon=True).start()
